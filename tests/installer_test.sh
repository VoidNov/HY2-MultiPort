...
make_release_fixture() {
    local version=0.0.3 target=x86_64-unknown-linux-gnu
...
if run_installer "$invalid_option_output" status --version 0.0.3; then
...
run_installer "$dry_run_output" --dry-run --version v0.0.3 --base-url "file://$fixture_root/releases"
assert_contains '版本 v0.0.3' "$dry_run_output"
...
run_installer "$install_output" --version 0.0.3 --base-url "file://$fixture_root/releases"
