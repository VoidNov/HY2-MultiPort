...
make_release_fixture() {
    local version=0.0.5 target=x86_64-unknown-linux-gnu
...
if run_installer "$invalid_option_output" status --version 0.0.5; then
...
run_installer "$dry_run_output" --dry-run --version v0.0.5 --base-url "file://$fixture_root/releases"
assert_contains '版本 v0.0.5' "$dry_run_output"
...
run_installer "$install_output" --version 0.0.5 --base-url "file://$fixture_root/releases"
...
run_stdin_installer "$fresh_output" --version 0.0.5 --base-url "file://$fixture_root/releases"
